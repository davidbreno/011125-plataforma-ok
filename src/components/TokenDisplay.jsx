    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl text-slate-400">Carregando...</p>
        </div>
      </div>
    )
  }
      ...
      <header className="bg-white/5 backdrop-blur-xl border-b border-white/10 p-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center space-x-3 mb-2">
            ...
            <h1 className="text-3xl font-bold">Fila de Pacientes</h1>
          </div>
      ...
      <main className="max-w-4xl mx-auto p-6">
        ...
        {currentToken && (
          <div className="bg-gradient-to-r from-green-500/20 to-blue-500/20 border border-green-400/30 rounded-3xl p-8 backdrop-blur-xl mb-8 text-center">
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-green-400 mb-2">Em atendimento</h2>
              ...
              <div className="text-center">
                ...
                <p className="text-lg text-slate-300">
                  {currentToken.patientAge} anos, {currentToken.patientGender}
                </p>
        ...
        {nextToken && (
          <div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-400/30 rounded-3xl p-8 backdrop-blur-xl mb-8 text-center">
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-blue-400 mb-2">Próximo paciente</h2>
              ...
              <div className="text-center">
                ...
                <p className="text-lg text-slate-300">
                  {nextToken.patientAge} anos, {nextToken.patientGender}
                </p>
                <p className="text-slate-400 mt-2">
                  <Clock className="w-4 h-4 inline mr-2" />
        ...
        {!currentToken && !nextToken && (
          <div className="bg-white/5 border border-white/10 rounded-3xl p-12 backdrop-blur-xl text-center">
            ...
            <h2 className="text-2xl font-bold text-slate-300 mb-4">Nenhuma senha ativa</h2>
            <p className="text-slate-400 text-lg">
              Nenhum paciente está aguardando ou sendo atendido no momento.
            </p>
          </div>
        )}
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-slate-400">
            <div className="flex items-center justify-center space-x-2">
              ...
              <span>Verde: Em atendimento</span>
            </div>
            <div className="flex items-center justify-center space-x-2">
              <div className="w-3 h-3 bg-blue-400 rounded-full"></div>
              <span>Azul: Próximo na fila</span>
            </div>
            <div className="flex items-center justify-center space-x-2">
              <div className="w-3 h-3 bg-slate-400 rounded-full"></div>
              <span>Cinza: Aguardando senha</span>
            </div>
          </div>
        </div>
      </main>
