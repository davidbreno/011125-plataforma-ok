...
export default function TokenManagement() {
      ...
      <html>
        <head>
          ...
          <style>
            ...
            .token { font-size: 48px; font-weight: bold; color: var(--accent-blue); margin: 20px 0; }
  ...
  const getStatusInfo = (status) => {
    switch (status) {
      case 'scheduled':
      return { color: 'text-primary-400 bg-primary-20', icon: ClockIcon }
      ...
      <header className="bg-white/5 backdrop-blur-xl border-b border-white/10 p-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            <Link 
              to="/receptionist"
              className="flex items-center space-x-2 px-3 py-2 bg-primary-20 hover:bg-primary-20 text-primary-400 rounded-lg transition-colors"
            >
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-4">
              <input
                ...
                className="px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-white focus:border-primary focus:outline-none"
              />
              
              <div className="text-center">
                <div className="text-2xl font-bold text-primary-400">{appointments.length}</div>
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-white/5 border border-white/10 rounded-lg text-white placeholder-slate-400 focus:border-primary focus:outline-none"
                />
              </div>
            </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl backdrop-blur-xl overflow-hidden">
          {loading ? (
            <div className="flex items-center justify-center min-h-96">
              <div className="text-center">
                <div className="animate-spin rounded-full h-12 w-12 border-b-2" style={{ borderTopColor: 'var(--accent-blue)' }}></div>
                          ...
                          {appointment.tokenNumber ? (
                            <div className="flex items-center space-x-2">
                              <div className="w-12 h-12 bg-primary-20 rounded-lg flex items-center justify-center">
                                <span className="text-xl font-bold text-primary-400">{appointment.tokenNumber}</span>
                              </div>
                              <button
