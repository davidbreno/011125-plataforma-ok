      ...
      <header className="bg-white/5 backdrop-blur-xl border-b border-white/10 p-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-bold">{isEditing ? 'Editar Fatura' : 'Criar Nova Fatura'}</h1>
              <p className="text-sm text-slate-400">{isEditing ? 'Modificar detalhes da fatura existente' : 'Gerar fatura para serviços do paciente'}</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
            <div className="flex justify-between items-center mb-4">
                ...
                <span>Seleção Rápida de Serviços</span>
              </h2>
                <button
                type="button"
              ...
              >
                ...
                <span>{showQuickServices ? 'Ocultar' : 'Mostrar'} serviços rápidos</span>
              </button>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-center">
                  ...
                  >
                    ...
                    <span>Preencher a partir da consulta</span>
                  </button>
                </div>
              ...
              {invoiceData.items.map((item, index) => (
                <div key={index} className="grid grid-cols-12 gap-4 items-end p-4 bg-white/5 rounded-lg border border-white/10">
                  <div className="col-span-6">
                      ...
                      placeholder="Serviço ou descrição do item"
                    />
                  </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-slate-800 border border-white/10 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-hidden">
            ...
            <div className="flex justify-between items-center p-6 border-b border-white/10">
              <h2 className="text-xl font-bold text-white">Selecionar Paciente</h2>
              <button
                onClick={() => {
                  setShowPatientModal(false)
                  setPatientSearchTerm('')
              ...
              {filteredPatients.length > 0 ? (
                ...
                <div className="p-8 text-center">
                  <div className="text-slate-400 text-lg mb-2">
                    {patientSearchTerm ? 'Nenhum paciente encontrado para sua pesquisa.' : 'Nenhum paciente disponível.'}
                  </div>
                  <div className="text-slate-500 text-sm">
                    {patientSearchTerm ? 'Tente um termo de pesquisa diferente.' : 'Crie consultas primeiro para ver pacientes aqui.'}
                  </div>
                </div>
              )}
            </div>
