      ...
      <header className="bg-white/5 backdrop-blur-xl border-b border-white/10 p-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-bold">Processamento de Pagamentos</h1>
              <p className="text-sm text-slate-400">Processar pagamentos de faturas pendentes</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto p-6">
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl mb-6">
          <div className="max-w-md">
            <label className="block text-sm font-medium text-slate-300 mb-2">Pesquisar Faturas</label>
        ...
        <div className="mb-4">
          <p className="text-slate-400">
            Encontradas {filteredInvoices.length} faturas pendentes
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredInvoices.length === 0 ? (
            <div className="col-span-full text-center py-12">
              ...
              <p className="text-slate-400 text-lg">Nenhuma fatura pendente encontrada</p>
              <p className="text-slate-500 text-sm">Todas as faturas foram pagas</p>
            </div>
          ) : (
