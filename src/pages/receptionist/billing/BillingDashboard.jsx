    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-400">Carregando dados de faturamento...</p>
        </div>
      </div>
    )
  }
      ...
      <header className="bg-white/5 backdrop-blur-xl border-b border-white/10 p-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-bold">Painel de Faturamento e Pagamentos</h1>
              <p className="text-sm text-slate-400">Gerencie faturas, pagamentos e faturamento</p>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold">Ver Faturas</h3>
                  <p className="text-sm text-slate-400">Gerenciar todas as faturas</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Processar pagamentos</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Gerar relatórios</p>
                </div>
              </div>
            </Link>
          </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold">Faturas Recentes</h2>
            <Link
              to="/receptionist/billing/invoices"
          ...
          {recentInvoices.length === 0 ? (
            <p className="text-slate-400 text-center py-8">Nenhuma fatura encontrada</p>
          ) : (
