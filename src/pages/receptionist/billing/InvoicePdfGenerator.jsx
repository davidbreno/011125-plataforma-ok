...
export default function InvoicePdfGenerator() {
      ...
      printWindow.document.write(`
        ...
        <head>
          ...
          <style>
            ...
            .status-paid { background-color: var(--status-success-bg); color: var(--status-success); }
            .status-pending { background-color: var(--status-warning-bg); color: var(--status-warning); }
            .status-overdue { background-color: var(--status-danger-bg); color: var(--status-danger); }
            .footer {
              margin-top: 40px;
              text-align: center;
              font-size: 12px;
  ...
  if (loading) {
    return (
      <div className="min-h-screen text-white flex items-center justify-center" style={{ background: 'linear-gradient(120deg, var(--color-1), var(--color-primary-600))' }}>
    ...
    <div className="min-h-screen text-white" style={{ background: 'linear-gradient(120deg, var(--color-1), var(--color-primary-600))' }}>
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex space-x-3">
            ...
            <button
              ...
              className="bg-primary hover:bg-primary-600 text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition-colors"
            >
      ...
      <main className="max-w-4xl mx-auto p-6">
        ...
        <div className="bg-white text-gray-900 rounded-2xl shadow-2xl overflow-hidden">
          {/* Invoice Header */}
          <div className="bg-gradient-to-r from-primary to-primary-600 text-white p-8 text-center">
            <h1 className="text-3xl font-bold mb-2">City Medical Center</h1>
            <p className="text-white">123 Healthcare Avenue, Medical District</p>
            <p className="text-white">Phone: +91 98765 43210 | Email: info@citymedical.com</p>
            <p className="text-white text-sm">GSTIN: 27ABCDE1234F1Z5</p>
          </div>
          ...
          <div className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <div>
                <h2 className="text-lg font-semibold text-primary-600 mb-4 flex items-center space-x-2">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <p><span className="font-medium">Invoice #:</span> <span className="font-mono text-primary-600">{invoice.invoiceNumber}</span></p>
            ...
            {/* Invoice Items */}
            <div className="mb-8">
              <h2 className="text-lg font-semibold text-primary-600 mb-4">Invoice Items</h2>
