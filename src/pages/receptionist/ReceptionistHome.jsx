    ...
    <div>
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8 mx-8">
          <Link to="/receptionist/appointments" className="flex flex-col items-center justify-center p-3 rounded-lg hover:scale-105 transition-transform" style={{ backgroundColor: '#101a29', border: '1px solid #1a2332', minWidth: '80px' }}>
          ...
          <Link to="/receptionist/token" className="flex flex-col items-center justify-center p-3 rounded-lg hover:scale-105 transition-transform" style={{ backgroundColor: '#101a29', border: '1px solid #1a2332', minWidth: '80px' }}>
          ...
          <Link to="/receptionist/billing" className="flex flex-col items-center justify-center p-3 rounded-lg hover:scale-105 transition-transform" style={{ backgroundColor: '#101a29', border: '1px solid #1a2332', minWidth: '80px' }}>
            <FaDollarSign className="text-2xl mb-1" style={{ color: '#4fd8d5' }} />
            <span className="text-xs font-medium" style={{ color: 'var(--color-text)' }}>Cobrança</span>
          </Link>
        </div>
