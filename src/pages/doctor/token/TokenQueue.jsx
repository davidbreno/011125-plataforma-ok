  ...
  return (
    <div className="min-h-screen p-8 bg-hero-dark">
      ...
      <header className="card-surface p-6 mb-6" style={{ borderRadius: '1.5rem' }}>
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold" style={{ color: 'var(--color-text)' }}>Fila de Pacientes</h1>
              <p className="text-sm" style={{ color: 'var(--color-text-light)' }}>Visualizar e gerenciar senhas dos pacientes de hoje</p>
            </div>
          </div>
          <button 
      ...
      <main className="space-y-6">
        {/* Error Display */}
        {error && (
          <div className="card-surface p-4" style={{ backgroundColor: '#fee2e2', border: '1px solid #fca5a5' }}>
            <div className="flex items-center gap-3">
        ...
        {currentToken && (
          <div className="card-surface p-6" style={{ background: 'linear-gradient(135deg, var(--color-secondary) 0%, rgba(200,134,84,0.1) 100%)' }}>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-20 h-20 rounded-2xl flex items-center justify-center" style={{ backgroundColor: 'var(--color-primary)' }}>
                  <span className="text-4xl font-bold text-white">{currentToken.tokenNumber}</span>
                </div>
                <div>
                  <h2 className="text-2xl font-bold" style={{ color: 'var(--color-text)' }}>Paciente Atual</h2>
                  <p className="text-lg font-semibold" style={{ color: 'var(--color-primary)' }}>{currentToken.patientName}</p>
                  <p style={{ color: 'var(--color-text-light)' }}>
                    {currentToken.patientAge} anos, {currentToken.patientGender} • {currentToken.appointmentTime}
                  </p>
                </div>
              </div>
